...
namespace Services
{
        ...
        where T : class
    {
        ...
        {
            var requiredProporties = GetRequiredProperties(fieldsString);
            return FetchDataForEntity(entity, requiredProporties);
        }
        ...
        private IEnumerable<ShapedEntity> FetchData(IEnumerable<T> entites,
            IEnumerable<PropertyInfo> requiredProperties)
        {
