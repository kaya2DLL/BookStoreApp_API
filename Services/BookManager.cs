...
namespace Services
{
    public class BookManager : IBookService
    {
        ...
        private readonly IBookLinks _booksLinks;
        public BookManager(IRepositoryManager manager, ILoggerService logger, IMapper mapper, IBookLinks booksLinks, ICategoryService categoryService)
        {
            _manager = manager;
            _logger = logger;
            _mapper = mapper;
            _booksLinks = booksLinks;
            ...
            bool trackChanges)
        {
            ...
            var _links = _booksLinks.TryGenerateLinks(booksDto, linkParameters
                .BookParameters.Fields,
                linkParameters.HttpContext);
            return (linkResponse: _links, metaData: booksWithMetaData.MetaData);
        ...
        public async Task<IEnumerable<Book>> GetAllBooksWithDetails(bool trackChanges)
        {
            return await _manager
                .Book
                .GetAllBooksWithDetails(trackChanges);
        }
        ...
        public async Task<(BookDtoForUpdate bookDtoForUpdate, Book book)> GetOneBookForPatchAsync(int id, bool trackChanges)
        {
            ...
            if (book is null)
                throw new BookNotFoundExcepiton(id);
        ...
        public async Task UpdteOneBookAsync(int id, BookDtoForUpdate bookDto, bool trackChanges)
        {
            //check entitiy
            var entity = await GetOneBookAndCheckExist(id, trackChanges);
